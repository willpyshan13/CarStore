...
public class SortTrainNewsAdapter extends BaseQuickAdapter<CourseParentInfoRes, BaseViewHolder> {


    public SortTrainNewsAdapter(int layoutResId, @Nullable List<CourseParentInfoRes> data) {
